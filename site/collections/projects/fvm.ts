...
export default new Project("fvm.chiri.works")
	.setOrder(2)
	.setType("Websites")
	.setImage("https://fvm.chiri.works/image/logo.png", image => image
		.class("borderless"))
	.setLink("https://fvm.chiri.works")
	...
	.setDescription(`
		...
		fvm is a long-term project for me; it's a blank slate for me to add more features and polish to until it's to the point where it's silly for people *not* to use it. And until then, something for me to chip away at whenever I'm in the mood.`);
